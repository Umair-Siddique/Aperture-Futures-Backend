...
# os.makedirs("processed_files_2002", exist_ok=True)
...
#         output_path = os.path.join("processed_files_2002", f"{base_filename}_chunk_{idx + 1}.json")
...
#     folder = "2002"
#     failed_file_name = "2002/S_RES_1454_2002_EN.pdf"

#     blobs = fetch_pdfs_from_bucket(bucket_name, folder)

#     for blob in blobs:
#         if blob.name == failed_file_name:
#             try:
