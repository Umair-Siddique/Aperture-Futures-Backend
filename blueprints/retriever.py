...
from .system_prompt import get_system_prompt, PROMPT_KEY_LIFELINES_RETRIEVER
...
def retrieve_transcript(user):
    ...
    system_prompt = get_system_prompt(PROMPT_KEY_LIFELINES_RETRIEVER, DEFAULT_LIFELINES_SYSTEM_PROMPT)
